...
function generateMetaImage(options, post) {
  ...
  var defaultImageUrl = options.localized.default_og_image ? options.localized.default_og_image.sizes['social-share-large'] : ''; // Override if OG enabled and image url
