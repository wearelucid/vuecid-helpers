...
exports.default = isWordPressPreview;
 ...
 */
function isWordPressPreview(route) {
  return !!(route && route.query && route.query.preview && route.query.preview_nonce && route.query.preview_id);
}